...
static void gap_advertise_start(GapState new_state)
{
	...
	const uint8_t choiceSelection[] = {
	  0x16, 0xff, 0x4c, 0x00, 0x04, 0x04, 0x20, 0x00, 0x00, 0x00, 0x0f, 0x05, 0xc0, 0x09, 0x60, 0x4c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
	status = aci_gap_update_adv_data(0x17, choiceSelection);
